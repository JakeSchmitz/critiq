class Feature < ActiveRecord::Base
  ...
  has_many :upvotes, class_name: "Like", foreign_key: "likeable_id", :as => :likeable, dependent: :destroy
  has_many :downvotes, class_name: "Like", foreign_key: "likeable_id", :as => :likeable, dependent: :destroy
