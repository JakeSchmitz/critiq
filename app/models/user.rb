class User < ActiveRecord::Base
  ...
  attr_accessible :id, :name, :screen_name, :email, :bio, :creator, :creator_code, :password_reset_token, :age, :password, :password_confirmation, :image_asset, :remember_token, :link, :user_id, :product_id,
