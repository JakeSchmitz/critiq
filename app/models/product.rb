class Product < ActiveRecord::Base
  ...
  attr_accessible :name, :description, :rating, :likes, :pictures, :pictures_attributes, :product_pic, :product_pic_attricbutes, :feature_groups, likes: [:product_id, :user_id]
